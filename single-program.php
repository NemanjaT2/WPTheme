...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        if ($relatedProfessors->have_posts()) {
            ...
            echo '<h2 class="headlrine headline--medium">' . get_the_title() . ' Professor(s)</h2>';
        ...
        // Must run this fun, cuz to reset data between 2 querys
        wp_reset_postdata();
        ...
        if ($homepageEvents->have_posts()) {
            echo '<hr class="section-break">';
            echo '<h2 class="headlrine headline--medium">Upcoming ' . get_the_title() . ' events</h2>';
